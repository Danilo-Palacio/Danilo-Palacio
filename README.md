# Danilo Vinicius Carvalho Palacio
...
|--------|-----------|-------------|
| [Sistema bancário](https://github.com/Danilo-Palacio/sistema_bancario/tree/main) | O sistema foi iniciado no Bootcamp “DIO & Suzano - Python Developer” como prática de fundamentos da linguagem Python, sendo posteriormente expandido para contemplar funcionalidades adicionais de gestão de usuários e contas. | Python |
